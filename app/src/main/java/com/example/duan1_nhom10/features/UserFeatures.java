...
import com.example.duan1_nhom10.MainActivity;
...
import com.example.duan1_nhom10.screen.ComicStoreScreen;
...
public class UserFeatures {
    ...
    public void kiemTraDangNhap(String tenNguoiDung, String matKhau){
        if (tenNguoiDung.isEmpty()||matKhau.isEmpty()){
            Toast.makeText(context, "Tên người dùng hoặc mật khẩu không đúng", Toast.LENGTH_SHORT).show();
        }else {
    ...
    public void dangKy(String tenNguoiDung, String matKhau,String matKhau2){
